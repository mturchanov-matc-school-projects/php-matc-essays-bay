...
if (!isset($_SESSION['user_id']))
{
    if (isset($_POST['submit']))
    {
        ...
        if (!empty($user_username) && !empty($user_password))
        {
            ...
            $query = "SELECT user_id, username,super_user FROM users WHERE" . " username = '$user_username' AND password = SHA('$user_password')";
            ...
            if (mysqli_num_rows($data) == 1)
            {
                ...
                @setcookie('super_user', $row['super_user'], time() + (60 * 60 * 24 * 30)); // expires in 30 days
        ...
        else
        {
            ...
            $error_msg = 'Fields cannot be empty. Try again';
        }
    }
}
...
<!--<p class="text-success">Sucessful login, do you want to redirect to <a href="index.php">Homepage</a></p>-->
